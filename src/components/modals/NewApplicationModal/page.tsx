          ...
          <div className="bg-white rounded-xl w-[90vw] xl:w-[800px] lg:w-[800px] md:w-[800px] h-[90vh] overflow-y-auto shadow-lg;">
            <div className="flex flex-col h-full justify-between items-center w-full">
              <div className="w-full">
                <div className="flex justify-between p-6 pb-5 items-center mb-3 border-b  border-gray-100">
                  <h2 className="text-lg font-semibold sm:px-0 lg:px-3 mb-1">
                    Add New Application
                  </h2>
                  <button
                ...
                <div className="px-4 sm:px-8">
                  <div className="flex justify-star">
                    <div className="flex flex-col items-start space-y-2 mt-1 w-full">
                        ...
                        {steps.map((step, index) => (
                          <div key={step.id} className="flex items-center">
                            ...
                            {index !== steps.length - 1 && (
                              <div
                                className={`w-[100px] sm:w-[200px] md:w-[350px] h-1 ${
                                  currentStep > step.id
                                    ? "bg-[#42DA82]"
                                    : "bg-[#D1D5DB]"
                                }`}
                      ...
                      <div className="  w-full px-2 sm:px-0 sm:justify-center sm:space-x-[150px] md:space-x-[310px]">
                        {steps.map((step) => (
                          <span
                            key={step.id}
                            className={`text-[14px] sm:text-[18px] font-[500] ${
                              currentStep >= step.id
                                ? "text-black"
                                : "text-gray-500"
                            }`}
                  ...
                  >
                    {({
                      ...
                      <Form className="flex flex-col h-full justify-between">
                                  ...
                                  <>
                                    ...
                                    ele.field_type === "image" ? (
                                      <div className="w-full col-span-1 sm:col-span-2">
                                        <label className="text-[#24282E] font-jakarta font-[500] text-[16px] sm:text-[18px] mb-2 block">
                                          {ele.label}
                                        </label>
                                        <FileUploadBox
                                          filePreview={
                                      ...
                                      <div className="col-span-1 sm:col-span-2 flex flex-col gap-2 mt-2">
                                        <span className="text-[#24282E] font-jakarta font-[500] text-[16px] sm:text-[18px]">
                                          {ele.label}
                                        </span>
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                          {ele.options.map((option) => (
                                            ...
                                            >
                                              ...
                                              />
                                              <div className="w-5 h-5 flex items-center justify-center rounded-full border-2 border-gray-400 peer-checked:bg-[#42DA82] peer-checked:border-[#42DA82] transition-colors">
                                                <div className="w-2.5 h-2.5 bg-white rounded-full transition-transform peer-checked:scale-100 scale-0" />
                                              </div>
                                      ...
                                      <div className="col-span-1 sm:col-span-2 flex flex-col gap-2 mt-2">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                          <Field
                                            ...
                                            className="hidden peer"
                                          />
                                          <div className="w-5 h-5 flex items-center justify-center rounded-[4px] border-2 border-gray-400 peer-checked:bg-[#42DA82] peer-checked:border-[#42DA82] transition-colors">
                                            <Check className="w-4 h-4 text-white transition-transform peer-checked:scale-100 scale-0" />
                                          </div>
                                          <span className="text-[#24282E] font-jakarta font-[500] text-[16px] sm:text-[18px]">
                                            {ele.label}
                                          </span>
                                      ...
                                      <div className="flex flex-col gap-2 col-span-1 sm:col-span-2">
                                        <label className="text-[#24282E] text-[16px] sm:text-[18px] font-[500] font-jakarta">
                                          {ele.label}
                                        </label>
                                        <textarea
                                          {...field}
                        ...
                        <div className="w-full">
                          <hr className="my-2" />
                          <div className="flex justify-end p-4 sm:p-6 pr-0 pt-0 items-center">
                            <div className="flex flex-col sm:flex-row gap-2 items-center w-full sm:w-auto">
                              <button
                                type="button"
                                className={`${styles.refundBtn} w-full sm:w-auto justify-center`}
                              >
                                <CopyGreenSvg />
                              ...
                              <button
                                type="button"
                                className="bg-[#42DA82] text-white px-6 py-2 rounded-[12px] font-semibold w-full sm:w-auto"
                                onClick={() =>
